...
class AddressTest(unittest.TestCase):
    ...
    def test_apt_prefix(self):
        ...
        self.assertEqual(None, addr.zip_code)
        self.assertEqual('2', addr.secondary_number)
        self.assertEqual('apt', addr.secondary_designator)
    ...
    def test_simple_address_issue_(self):
	      ...
	      self.assertEqual('#400', addr.secondary_number)
    ...
    def test_second_delivery_line_has_floor(self):
	      ...
	      self.assertEqual('2nd', addr.secondary_number)
	      self.assertEqual('Floor', addr.secondary_designator)
